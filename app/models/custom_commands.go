...
var (
	customCommandColumns               = []string{"id", "group_id", "command", "message", "created_at", "updated_at"}
	customCommandColumnsWithoutDefault = []string{"group_id", "command", "message", "created_at", "updated_at"}
